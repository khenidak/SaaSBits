...
function New-WebDeployPackage
{
    ...
    ."C:\Program Files (x86)\MSBuild\12.0\Bin\amd64\MSBuild.exe" "..\SaaS.Services.HrApp\SaaS.Services.HrApp.csproj" /T:Package  /p:PackageLocation="$execDirectory\WebPackages\SaaS.Services.HrApp.zip" >> $execDirectory\BuildLog.log
    $CurrentWebDeployPackage =  Join-Path -path $execDirectory -ChildPath "WebPackages\SaaS.Services.HrApp.zip"
